              ...
              <div key={entry.id} style={{ background: "#1a2332", borderRadius: 12, border: "1px solid #1e293b", padding: 20, marginBottom: 12 }}>
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  {entry.crewMembers.map(crew => {
                    ...
                    return (
                      <div key={crew.id} style={{ background: "#0f1729", borderRadius: 8, padding: "10px 12px", marginBottom: 6, border: "1px solid #1e293b" }}>
                        {/* Crew member header */}
                          ...
                          return (
                            <div key={alloc.id} style={{ marginBottom: 6 }}>
                              <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
                                <select
                                  style={{ ...iS, flex: "2 1 180px", minWidth: 160, background: "#1a2332", fontSize: 12, borderLeft: overrun ? "3px solid #ef4444" : "1px solid #1e293b" }}
                                ...
                                <input
                                  ...
                                  style={{ ...iS, width: 80, textAlign: "right", background: "#1a2332", fontSize: 12 }}
                                  value={alloc.hours || ""}
                        ...
                        <button
                          ...
                          style={{ display: "flex", alignItems: "center", gap: 4, marginTop: 4, background: "none", border: "1px dashed #1e293b", color: "#818cf8", fontSize: 11, cursor: "pointer", fontFamily: "inherit", padding: "4px 10px", borderRadius: 6 }}
                        >
